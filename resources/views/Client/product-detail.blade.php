                    ...
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <div class="p-t-33">
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                ...
                                <div class="size-204 respon6-next">
                                    <div class="rs1-select2 bor8 bg0" style="padding:7px;">
                                        <textarea name="" id="" cols="30" style="width: 100%" rows="10"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                <div class="size-204 flex-w flex-m respon6-next">
                                    ...
                                    {{-- @if (Auth::guard('customer')->check())
                                        @auth --}}
                                            <a href="{{ Auth::guard('customer')->check() ? url('produk/cart/create/' . $product->id) : url('login') }}"
                                                class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 {{ Auth::guard('customer')->check() ? ('js-addcart-detail') : ""}} ">
                                                Add to cart
                                            </a>
                                        {{-- @endauth --}}
                                    {{-- @else
                                        <a href="{{ url('login') }}" style="font-size:20px; font-weight:800; color:red;"
                                            >
                                            Klik disini untuk Login terlebih dahulu
                                        </a>
                                    @endif --}}
